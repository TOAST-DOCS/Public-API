...
NHN Cloud Public API는 프레임워크 API, 파트너 관리 API, 각 서비스마다 서로 다른 인증 방식을 지원합니다. [Public API별 인증 방식](link 추가)에서 서비스별로 지원하는 인증 방식을 확인한 뒤, 해당 인증 방식을 사용해 API 요청을 인증하세요.
